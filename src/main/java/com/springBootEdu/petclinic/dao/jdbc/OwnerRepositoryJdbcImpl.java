package com.springBootEdu.petclinic.dao.jdbc;
...
import com.springBootEdu.petclinic.dao.OwnerRepository;
...
public class OwnerRepositoryJdbcImpl implements OwnerRepository {
	...
	public void create(Owner owner) {
		String sql = "insert into t_owner(id,first_name,last_name) values(12,?,?)";
	    jdbcTemplate.update(sql,owner.getFirstName(),owner.getLastName());
